...
if(message.content.startsWith(prefix + "daily")) {
  if(profile[message.author.id].lastDaily != moment().format('24h')) {
    profile[message.author.id].lastDaily = moment().format('24h')
